...
class HistorySmokeList extends StatefulWidget {
  const HistorySmokeList({Key? key}) : super(key: key);

  @override
  _HistorySmokeListState createState() => _HistorySmokeListState();
}

class _HistorySmokeListState extends State<HistorySmokeList> {
  late Query _ref;
  DatabaseReference reference =
  FirebaseDatabase.instance.reference().child("history").child("smoke");
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text((snapshot.value['value']).toString()+'ppm',
